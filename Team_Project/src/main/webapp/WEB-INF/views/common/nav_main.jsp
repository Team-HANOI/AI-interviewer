	...
	<div
		...
		<nav id="navbar" class="navbar">
			<ul>
				...
				<li class="dropdown"><a href="/interview/"><span>면접하기</span>
				...
				<li class="dropdown"><a href="/board/"><span>커뮤니티</span> <i
        ...
        <li><a href="/board/best_answers">모범답안</a></li> -->
				...
				<sec:authorize access="isAnonymous()">
					<li class="dropdown"><a href="#"><span>회원가입</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
				...
				<sec:authorize access="isAuthenticated()">
					<li class="dropdown"><a href="#"><span>${user.name}님<c:if
									test="${fn:contains(user.type, 'C')}">(기업)</c:if></span> <i
							class="bi bi-chevron-down"></i> </a>
						<ul>
