...
public class InterviewController {
  ...
  public void saveAnswerVoice(MultipartHttpServletRequest multi, @RequestParam("type") int type,
      @RequestParam(value = "pos", required = false) String pos,
      @RequestParam(value = "kws", required = false) String kws,
      @RequestParam("qIds") List<String> qIds, @RequestParam("answers") List<String> answers)
      throws Exception {
    try {
