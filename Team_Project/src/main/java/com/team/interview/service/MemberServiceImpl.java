...
//    File file = new File("/image/default_pf_img.jpg");
	...
	public void joinCom(MemberVO memberVO, MultipartFile logoImg) throws Exception {
		...
		if (logoImg.getSize() == 0) { // 날라온게 없으면 디폴트 이미지로
			File file = new File(
					new File("").getAbsolutePath() + "/src/main/resources/static/image/default_pf_img.jpg");
//			File file = new File("/image/default_pf_img.jpg");
	...
	@Override
	public void updateMypageProfile(MemberVO memberVO, ProfileVO profileVO, MultipartFile pfImg) throws Exception {
